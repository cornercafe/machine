...
void loop()
{
  ...
  qrcode_initText(&qrcode, qrcodeData, 9, 1, "upi://pay?pa=paytm-69351358@paytm&pn=SHEEJAMOL%20C%20T&mc=5499&tr=c52c355fe83145b1b2746af822bed0d9&am=100&cu=INR");
Serial.println();
Serial.println();
Serial.println();
Serial.println();
  ...
  for (int y = 0; y < qrcode.size; y++)
  {
    ...
    for (int x = 0; x < qrcode.size; x++)
    {
      ...
      LCD_rect(x * 4 + 5, y * 4 + 5, 4, 4, qrcode_getModule(&qrcode, x, y) ? BLACK : WHITE);
